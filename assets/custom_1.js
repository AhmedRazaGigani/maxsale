...
// check purchase code
// This code is designed to bypass license activation for a Shopify theme.
// It uses a combination of base64 encoding, DOM manipulation, and API requests to achieve the activation.

// Decoding variable names and values
var ThemeCode = atob(window[atob("Y0hWeVkyaGg=")]),
  ThemeName = atob(window[atob("VkdobGJXVk9ZVzFsVkRR")]),
  CookieName =
    "SXNBY3RpdmVUaGVtZQ==" + atob(window[atob("VkdobGJXVk9ZVzFsVkRR")]),
  ...
  str_purchase = atob("cHVyY2hhc2VfY29kZXR0OA=="); // purchase_codet4
